...
- (UIImage*) processImageWithOpenCV:(UIImage*) sourceImage points: (CGPoint[]) points {
    ...
    cv::Mat original = [self cvMatFromUIImage:sourceImage];
...
- (NSArray *)detectEdges:(UIImage*) sourceImage size: (CGSize) targetSize {
    ...
    if (largest_square.size() == 4) {
        ...
        NSArray *detectedPoints = [NSArray arrayWithObjects:
                           [NSValue valueWithCGPoint:[[sortedPoints objectForKey:@"0"] CGPointValue]],
                           [NSValue valueWithCGPoint:[[sortedPoints objectForKey:@"1"] CGPointValue]],
                           [NSValue valueWithCGPoint:[[sortedPoints objectForKey:@"2"] CGPointValue]],
                           [NSValue valueWithCGPoint:[[sortedPoints objectForKey:@"3"] CGPointValue]],
                            nil];
...
- (UIImage *)UIImageFromCVMat:(cv::Mat)cvMat {
    ...
    CGImageRef imageRef = CGImageCreate(cvMat.cols, cvMat.rows, 8, 8 * cvMat.elemSize(), cvMat.step[0], colorSpace,
